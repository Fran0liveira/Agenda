...
//
    ...
    public Agenda(String nomeAgenda, ArrayList eventos){
        this.setNomeAgenda(nomeAgenda);
    ...
    public void removeEventoByIndex(int index) {
        this.eventos.remove(this.getEventoByIndex(index));
        numEventos--;
    }
    ...
    public ArrayList<Evento> getByMonth (int mes) {
        ArrayList<Evento> eventoAUX = new ArrayList<>();
    ...
    public ArrayList<Evento> getByDay (int dia){
        ArrayList<Evento> eventoAUX = new ArrayList<>();
        Calendar c1 = GregorianCalendar.getInstance();
        for (Evento evento : eventos) {
    ...
    public void addEventos(ArrayList eventos){
        this.eventos = eventos;
    }
    public int getNumEventos(){
        return numEventos;
    }
    public ArrayList getGlobais(){
        ArrayList globais = new ArrayList();
        for(Evento evento : eventos){
            if(evento.isGlobal()){
                globais.add(evento);
            }
